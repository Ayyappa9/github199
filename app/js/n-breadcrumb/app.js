...
angular.module('ncy-sample', ['ui.router.state', 'ui.bootstrap', 'ncy-angular-breadcrumb'])
  ...
  .config(function($stateProvider, $urlRouterProvider) {
    $stateProvider
      .state('home', {
        url: '/home',
        templateUrl: 'js/n-breadcrumb/views/home.html',
        ncyBreadcrumb: {
          label: 'Home'
        }
      })
      .state('sample', {
        url: '/sample',
        templateUrl: 'js/n-breadcrumb/views/sample.html',
        ncyBreadcrumb: {
          label: 'Sample'
        }
      })
      .state('booking', {
        url: '/booking',
        templateUrl: 'js/n-breadcrumb/views/booking_list.html',
      ...
      .state('booking.day', {
        url: '/:year-:month-:day',
        templateUrl: 'js/n-breadcrumb/views/booking_day.html',
      ...
      .state('booking.day.detail', {
        ...
        onEnter: function($stateParams, $state, $modal) {
          $modal.open({
            templateUrl: "js/n-breadcrumb/views/booking_detail.html",
      ...
      .state('room', {
        url: '/room',
        templateUrl: 'js/n-breadcrumb/views/room_list.html',
      ...
      .state('room.new', {
        ...
        views: {
          "@" : {
            templateUrl: 'js/n-breadcrumb/views/room_form.html',
      ...
      .state('room.detail', {
        ...
        views: {
          "@" : {
            templateUrl: 'js/n-breadcrumb/views/room_detail.html',
            controller: 'RoomDetailCtrl'
          }
        },
        ncyBreadcrumb: {
